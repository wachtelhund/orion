...
impl Action {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Action::Place1 => "BUILD SLOT 1",
            Action::Place2 => "BUILD SLOT 2",
            Action::Place3 => "BUILD SLOT 3",
            Action::Place4 => "BUILD SLOT 4",
            Action::Place5 => "BUILD SLOT 5",
            Action::Place6 => "BUILD SLOT 6",
            Action::Place7 => "BUILD SLOT 7",
